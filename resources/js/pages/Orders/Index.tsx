...
import { create, show, edit, destroy } from '@/actions/App/Http/Controllers/OrderController';
...
export default function Index({ orders }: { orders: Order[] }) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Orders" />
            <div className="flex">
                <div className="flex items-center text-2xl">Orders</div>
                <div className="ml-auto flex items-center">
                    <CustomLink label="Add order" href={create()} />
                </div>
            </div>
                                    ...
                                    {orders.map((item, index) => (
                                        <TableRow key={index}>
                                            ...
                                            <TableCell className="whitespace-nowrap">
                                                <h6 className="text-sm font-medium">{item.order_number}</h6>
                                            </TableCell>
                                            <TableCell className="whitespace-nowrap">
                                            ...
                                            <TableCell className="whitespace-nowrap">
                                                <h6 className="text-sm font-medium">{item.request_date}</h6>
                                            </TableCell>
                                            <TableCell className="whitespace-nowrap">
