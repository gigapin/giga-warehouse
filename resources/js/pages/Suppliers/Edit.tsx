...
export default function Edit({ supplier, municipalities }: { supplier: Supplier; municipalities: Municipality[] }) {
    return (
        <AppLayout>
            <Head title={`Edit ${supplier.company_name}`} />
            <div className='w-1/2'>
                <Form action={update(supplier.id)}>
                    {({ errors, wasSuccessful, processing }) => (
                        <FieldGroup>
                            <Field>
                                <FieldLabel htmlFor="company_name">Company Name</FieldLabel>
                                <Input id="company_name" name='company_name' defaultValue={supplier.company_name} />
                            ...
                            <Field>
                                ...
                                <Input id="fiscal_code" name='fiscal_code' defaultValue={supplier.fiscal_code} />
                            ...
                            <Field>
                                ...
                                <Select name="municipality_id" defaultValue={String(supplier.municipality_id)}>
                            ...
                            <Field>
                                ...
                                <Input id="sdi_code" name='sdi_code' defaultValue={supplier.sdi_code} />
                                {errors.sdi_code && <div className='text-red-600'>{errors.sdi_code}</div>}
                            </Field>
                            <Field>
                                <FieldLabel htmlFor="pec">PEC</FieldLabel>
                                <Input id="pec" name='pec' defaultValue={supplier.pec} />
