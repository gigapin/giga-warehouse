...
import { create, show, edit, destroy } from '@/actions/App/Http/Controllers/CustomerController';
...
export default function Index({ customers }: { customers: Customer[] }) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex">
                <div className="flex items-center text-2xl">Customers</div>
                <div className="ml-auto flex items-center">
                    <CustomLink label="Add customer" href={create()} />
                </div>
            </div>
