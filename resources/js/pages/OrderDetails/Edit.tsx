...
import { update } from '@/actions/App/Http/Controllers/OrderDetailController';
...
export default function Edit({ orderDetail, orders, items }: { orderDetail: OrderDetail; orders: Order[]; items: Item[] }) {
    return (
        <AppLayout>
            <Head title={`Edit Order Detail`} />
            <div className='w-1/2'>
                <Form action={update(orderDetail.id)}>
                    {({ errors, wasSuccessful, processing }) => (
                        <FieldGroup>
                            <Field>
                                <FieldLabel htmlFor="order_id">Order</FieldLabel>
                                <Select name="order_id" defaultValue={String(orderDetail.order_id)}>
                            ...
                            <Field>
                                ...
                                <Select name="item_id" defaultValue={String(orderDetail.item_id)}>
                            ...
                            <Field>
                                ...
                                <Input id="delivery_date" name='delivery_date' type='date' defaultValue={orderDetail.delivery_date} />
                            ...
                            <Field>
                                ...
                                <Input id="qta_ordered" name='qta_ordered' type='number' defaultValue={orderDetail.qta_ordered} />
                            ...
                            <Field>
                                ...
                                <Input id="qta_delivered" name='qta_delivered' type='number' defaultValue={orderDetail.qta_delivered} />
                            ...
                            <Field>
                                ...
                                <Input id="delivered" name='delivered' type='number' defaultValue={orderDetail.delivered} />
                                {errors.delivered && <div className='text-red-600'>{errors.delivered}</div>}
                            </Field>
                            <Field>
                                <FieldLabel htmlFor="note">Note</FieldLabel>
                                <Textarea id='note' name='note' defaultValue={orderDetail.note} />
